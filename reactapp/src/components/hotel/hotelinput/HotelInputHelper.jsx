    ...
    return (
        <>
            ...
            <div className='flex gap-3'>
                <Form.Select onChange={(event) => hotelDispatch({ type: HotelActions.SET_COUNTRY, payload: event.currentTarget.value })}>
                ...
                <Form.Select onChange={(event) => hotelDispatch({ type: HotelActions.SET_CITY, payload: event.currentTarget.value })}>
            ...
            <div className='flex gap-3 mt-3 w-full'>
                ...
                <div className='w-full'>
                    ...
                    <DatePicker onChange={(event) => hotelDispatch({ type: HotelActions.SET_CHECK_OUT_DATE, payload: event.target.value })}
